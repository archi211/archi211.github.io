    ...
    function a(ax, aG) {
        ...
        this.openzoom = function (u) {
            ...
            Q.xon("load", function () {
                ...
                W = h / aa;
                U = ah / aj;
                var aM, aN = ["padding-", "border-"];
                n = O = 0;
                for (var v = 0; v < aN.length; v++) {
                    aM = parseFloat(l.css(aN[v] + "top-width"));
                    n += aM !== aM ? 0 : aM;
                    aM = parseFloat(l.css(aN[v] + "bottom-width"));
                    n += aM !== aM ? 0 : aM;
                    aM = parseFloat(l.css(aN[v] + "left-width"));
                    O += aM !== aM ? 0 : aM;
                    aM = parseFloat(l.css(aN[v] + "right-width"));
                    O += aM !== aM ? 0 : aM
                }
                n /= 2;
                O /= 2;
